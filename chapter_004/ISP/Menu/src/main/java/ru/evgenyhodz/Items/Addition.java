 ...
 * @since 15.01.2017
 */
public class Addition extends Item implements NumbersInput {
    /**
     * Constructor.
     *
     ...
     */
    public Addition(String key, String name, ArrayList<Item> itemList) {
    ...
    public void execute() {
        ...
        calculate.add(numEnter(), numEnter());
